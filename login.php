...
<html
  ...
  data-assets-path="assests/admin/assets/"
  ...
  <body>
            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">RTConnect</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">Selamat Datang di <RTConnect></RTConnect> RTConnect! 👋</h4>
                <div class="mb-3 form-group">
                          <label for="exampleSelectPeran">Login sebagai </label>
                              <select class="form-control" id="exampleSelectPeran">
                              <option>Pengurus</option>
                                     
                              </select>
                </div>
              <form id="formAuthentication" class="mb-3" action="admin/pengurusrt.php" method="POST">
                <div class="mb-3">
                  <label for="email" class="form-label">No.KK atau Username</label>
                  <input
                    type="text"
                    class="form-control"
                    id="email"
                    name="email-username"
                    placeholder="Masukkan No.KK atau username"
                    autofocus
                  />
                </div>
    ...
    <script>
      function redirectToRole() {
        var selectedRole = document.getElementById("exampleSelectPeran").value;
        ...
        if (selectedRole === "Warga") {
          window.location.href = "wargart/warga.php";
        } else if (selectedRole === "Pengurus") {
          window.location.href = "admin/pengurusrt.php";
        }
