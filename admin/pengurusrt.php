      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="lapormasalah.php" class="menu-link">
                <i class="menu-icon tf-icons bx bx-home-circle"></i>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <a href="inputwarga.php" class="btn btn-primary btn-sm">Buat</a>
        ...
        <?php 
                if(isset($_GET['idwarga'])){
                    $idwarga = $_GET['idwarga'];
                    $query = mysqli_query($con,"SELECT * FROM data_warga WHERE no_kk = $idwarga");
                    if($query){
                        while ($data=mysqli_fetch_array($query)){?>
                        <tr>
                            <td class="p-4 "><?= $data['idwarga'] ?> </td>
                            <td class="p-4 "><?= $data['no_kk'] ?> </td>
                            <td class="p-4 "><?= $data['nama'] ?></td>
                            <td class="p-4 "><?= $data['alamat'] ?></td>
                            <td class="p-4 "><?= $data['status_tempat_tinggal'] ?></td>
                            <td class="p-4 "><?= $data['tanggal_pindah_masuk'] ?></td>
                            <td class="p-4 "><?= $data['	tanggal_pindah_keluar'] ?></td>
                            <td class="p-4 "><?= $data['catatan_tambahan'] ?></td>
                            <td><a href="penggurusrt.php?id=<?php echo $data['idwarga'] ?>" class="p-2  text-white  bg-red-400 rounded-xl">Delete</a></td>
                        </tr>
                        <?php } ?>
